package com.kodlamaio.hrmns.hrmns;
...
import com.kodlamaio.hrmns.hrmns.core.results.ErrorDataResult;

@SpringBootApplication
@RestControllerAdvice
public class HrmnsApplication {

	public static void main(String[] args) {
		SpringApplication.run(HrmnsApplication.class, args);
	}
